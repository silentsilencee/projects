...
def roll_dice(num_rolls, dice=six_sided):
    ...
    total_score=0
    pigout=0
    while dice_counter < int(num_rolls):
        value=int(dice())
        if value==1:
            pigout=1
...
def free_bacon(score):
    ...
    if score>0:
        ...
        digit_2=0
    max_digit=max(digit_1,digit_2)
    free_bacon_value=max_digit+1
    return free_bacon_value
    # END PROBLEM 2
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def announcer(score0, score1):
        ...
        new_high=(current_score-previous_score)
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    new_dice_value=0
    while num_rolls<11:
        dice_value=make_averaged(roll_dice,num_samples)(num_rolls, dice)
        if dice_value>new_dice_value:
            new_dice_value=dice_value
            dice_roll_number=num_rolls
        num_rolls=num_rolls+1
    return dice_roll_number
...
def bacon_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 10
    value_freebacon=free_bacon(opponent_score)
    if value_freebacon>=margin:
        return 0
    else:
        return num_rolls
    # END PROBLEM 10
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if value_freebacon>=margin:
        return 0
    elif is_swap(score+value_freebacon,opponent_score):
        return 0
    else:
